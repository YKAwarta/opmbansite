...
export function getWelcomeEmail(params: WelcomeEmailParams): string {
    const { fullName, email, inviteLink, useEmbeddedLogo = false } = params
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 8px; border: 2px solid #0abd62; margin-bottom: 30px;">
                <tr>
                  <td style="padding: 25px;">
                    <h2 style="color: #093968; margin: 0 0 20px 0; font-size: 18px; font-weight: 700;">🔐 Your Account</h2>
                    <table width="100%" cellpadding="8" cellspacing="0" border="0">
                      <tr>
                        <td style="color: #666; font-size: 14px; font-weight: 600; padding: 8px 0;">Email:</td>
                        <td style="color: #333; font-size: 14px; padding: 8px 0; font-family: 'Courier New', monospace;">
                          ${email}
                        </td>
                      </tr>
                    </table>
                    <p style="color: #555; font-size: 14px; line-height: 1.6; margin: 15px 0 0 0;">
                      Click the button below to set up your password and activate your account. This link is single-use and expires in 24 hours.
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 30px;">
                <tr>
                  <td align="center">
                    <a href="${inviteLink}" style="display: inline-block; background: linear-gradient(135deg, #093968 0%, #0abd62 100%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-weight: 700; font-size: 16px; box-shadow: 0 4px 12px rgba(10, 189, 98, 0.3);">
                      Set Up Your Account →
                    </a>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 20px;">
                    <p style="color: #856404; margin: 0; font-size: 14px; line-height: 1.6;">
                      ...
                      This invite link is for your use only and expires in 24 hours. Do not share it with anyone. If you did not expect this email, please ignore it.
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <ul style="color: #666; font-size: 15px; line-height: 1.8; padding-left: 20px; margin: 0 0 30px 0;">
                ...
                <li>Log in and explore your digital wallet</li>
