    ...
    <section className="py-16 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-brand-azure dark:text-white mb-12 text-center">
            Reach Out to Us
          </h2>
          ...
          <Card className="p-8 bg-gray-50 dark:bg-gray-800">
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div>
                ...
                <h4 className="font-semibold text-brand-azure dark:text-white mb-2">General Inquiries</h4>
                <a href="mailto:opmban.club@alfaisal.edu" className="text-sm text-brand-olive/60 dark:text-gray-400">
                    pm@alfaisal.edu
                </a>
              </div>
              <div>
                <Clock className="w-8 h-8 text-brand-green mx-auto mb-3" />
                <h4 className="font-semibold text-brand-azure dark:text-white mb-2">Urgent Contact Hours</h4>
                <p className="text-sm text-brand-olive/60 dark:text-gray-400">
              ...
              <div>
                ...
                <h4 className="font-semibold text-brand-azure dark:text-white mb-2">Response Time</h4>
                <p className="text-sm text-brand-olive/60 dark:text-gray-400">
                  Within 24-48 hours
                </p>
              </div>
