    ...
    <section id="about" className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          <h2 className="text-4xl font-bold text-[#093968] dark:text-white mb-6">About The Club</h2>
          <p className="text-lg text-[#0d0d0b]/80 dark:text-gray-300 leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <Card className="p-8 border-2 hover:border-brand-green transition-all shadow-sm hover:shadow-md">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#093968] dark:text-white mb-4">Our Vision</h3>
                <p className="text-[#0d0d0b]/80 dark:text-gray-300 leading-relaxed">
          ...
          <Card className="p-8 border-2 hover:border-brand-orange transition-all shadow-sm hover:shadow-md">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#093968] dark:text-white mb-4">Our Mission</h3>
                <p className="text-[#0d0d0b]/80 dark:text-gray-300 leading-relaxed">
